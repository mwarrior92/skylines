...
def plot_homogeneity_and_completeness(category):
    ...
    ax.legend(lines, [z.get_label() for z in lines], ncol=3, loc='center left',
            bbox_to_anchor=(0,1.3))
    ax.set_ylim([0,1])
    fig.savefig(D.fmt_path('plotsdir/homogeneity_and_completeness/'+category+'.png'))

def plot_homogeneity_and_completeness0(category):
    print(category)
    D = DataGetter()
    data = pandas.read_json(D.fmt_path('datadir/homogeneity_and_completeness/'+category+'.json'), lines=True)
    data = data.sort_values(by=['threshold'])
    ...
    ax.set_ylim([0,1])
    fig.savefig(D.fmt_path('plotsdir/homogeneity_and_completeness_presentation/'+category+'0.png'))

def plot_homogeneity_and_completeness1(category):
    print(category)
    D = DataGetter()
    data = pandas.read_json(D.fmt_path('datadir/homogeneity_and_completeness/'+category+'.json'), lines=True)
    data = data.sort_values(by=['threshold'])
    ...
    ax2.set_ylabel('# clusters', rotation=270)
    ax.set_ylim([0,1])
    fig.savefig(D.fmt_path('plotsdir/homogeneity_and_completeness_presentation/'+category+'1.png'))
...
def plot_homogeneity_and_completeness2(category):
    ...
    ax2.set_ylabel('# clusters', rotation=270)
    ax.set_ylim([0,1])
    fig.savefig(D.fmt_path('plotsdir/homogeneity_and_completeness_presentation/'+category+'2.png'))
...
if __name__ == '__main__':
    ...
    '''
    plot_homogeneity_and_completeness0('country')
    plot_homogeneity_and_completeness0('prefix')
    plot_homogeneity_and_completeness0('asn')
    plot_homogeneity_and_completeness1('country')
    plot_homogeneity_and_completeness1('prefix')
    plot_homogeneity_and_completeness1('asn')
    plot_homogeneity_and_completeness2('country')
    plot_homogeneity_and_completeness2('prefix')
    plot_homogeneity_and_completeness2('asn')
