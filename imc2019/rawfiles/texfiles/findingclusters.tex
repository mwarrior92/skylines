...
\begin{figure*}
    ...
    \caption{Completeness and homogeneity (for each feature) vs clustering distance threshold. The vertical line marks 0.73, which was found to be the CNRE value at which clients with different labels become distinguishable.}
\end{figure*}
